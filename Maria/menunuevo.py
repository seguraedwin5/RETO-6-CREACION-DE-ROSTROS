...
#cabello
  ...
  RostroCodificado = codif.codificar(Rostrodecodificado._asdict())
  ar.EscribirRostrojson(RostroCodificado._asdict())
  return print(" \n 💾 Rostro Guardado correctamente en la base de datos 💾!!!\n")
#------------------------------------------------

def Listartodo():
  listadorostros = ar.ListarRostrosjson(ar.ObtenerRostrosjson())
  

def BuscarporNombre():
  nombre_buscar = str(input("Digite el nombre del rostro que  desea buscar: \n"))
  diccrostro =ar.ObtenerRostroporNombre(nombre_buscar)
  rostrodecodificado =codif.decodificar(diccrostro)
  codif.mostrarRostrodecodif(rostrodecodificado)
